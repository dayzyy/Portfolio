...
export default function SocialsBar() {
	...
	const socials = [
		...
		<div className="relative grid place-items-center">
			{showAlert && (
				<div
					className={`absolute w-fit -top-10 z-20 bg-[var(--color-bg-sidebar)] py-1 px-3 rounded-xl`}
				>
		...
		<a
			href="https://www.linkedin.com/in/luka-mania-ab330a35a/"
			target="_blank"
			rel="noopener noreferrer"
		>
		...
		<a
			href="https://www.facebook.com/luka.mania.3745/"
			target="_blank"
			rel="noopener noreferrer"
		>
	...
	return (
		<div
			id="socials-box"
			className="flex flex-col items-center gap-4 max-w-[80%] select-none"
		>
			<div
				id="socials-bar"
				className="rounded-xl flex flex-wrap items-center justify-center gap-10 p-4"
			>
				{socials.map((social, index) => {
					return <span key={`icon ${index}`}>{social}</span>;
				})}
			</div>
