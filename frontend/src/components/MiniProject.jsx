...
export default function MiniProject({icon, description, on_click, mobile_screen}) {
	...
	<div className={`mini-project flex-shrink-0 w-[3rem] h-[3rem] bg-[var(--color-bg-program)] rounded-xl flex items-center justify-center cursor-pointer`}
	     onClick={on_click}
	     id={`${description} box`}
	>
